...
class TableTDS extends StatefulWidget {
  Changes change;

  TableTDS({required this.change});

  @override
  State<TableTDS> createState() => _TableTDSState();
}


class _TableTDSState extends State<TableTDS> {
  List<double> media = [];
  List DataDay = [];
